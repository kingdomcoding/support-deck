defmodule SupportDeck.SLA.Policy do
  ...
  actions do
    ...
    create :create do
      accept [:name, :subscription_tier, :severity, :first_response_minutes,
              :resolution_minutes, :escalation_thresholds, :enabled]
    end

    update :update do
      accept [:name, :first_response_minutes, :resolution_minutes,
              :escalation_thresholds, :enabled]
    end
