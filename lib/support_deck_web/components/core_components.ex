defmodule SupportDeckWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SupportDeckWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SupportDeckWeb.Gettext, "errors", msg, opts)
    # end
  ...
  def format_deadline(nil), do: "No deadline"
